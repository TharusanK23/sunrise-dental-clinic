...
<!-- SCREENSHOT-PENDING: swagger-overview.png, swagger-login-endpoint.png, swagger-login-executed.png, swagger-register-appointment-schema.png -->
...
<!-- SCREENSHOT-PENDING: login, dashboard, appointment-new, appointment-detail, billing-receipt, dentists, reports, help, staff-accounts, edit-staff-modal -->
...
<!-- SCREENSHOT-PENDING: tests-passing.png -->
