...
import com.sunrise.dentalclinic.dto.response.ApiErrorResponse;
 ...
 * {@link ApiErrorResponse} JSON shape instead of leaking stack traces - the
 * frontend relies on this shape to render field-level validation messages
 * inline on forms.
 */
